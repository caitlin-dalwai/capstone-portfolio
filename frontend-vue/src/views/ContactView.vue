<template>
    <div id="contactP">
        <div class="container pt-5">
            <h1 style="color: black; font-weight: bolder; margin-bottom: 1%;">Get In Touch !</h1>
            <div class="row">
                <div class="col-lg-3">
                    <FormComp/>
                </div>
  ...
  <div class="dog-body">
            ...
            <div class="col-lg-4" style="height: fit-content; color: black;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill=black class="bi bi-geo-alt" viewBox="0 0 16 16">
